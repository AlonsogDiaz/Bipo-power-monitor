...
#ifndef MP2790_DRIVER_H
#define MP2790_DRIVER_H
...
// Enum paraa permisos Read/Write
enum class RWAccess {
    READ_ONLY,
    WRITE_ONLY,
    READ_WRITE
...
// Enum para tipo de memoria Non-NVMType::VOLATILE
enum class NVMType {
    VOLATILE,
...
/**
 * @brief Estructura descriptora de regitros
 * @param addr int Parent Address
 * @param start Starting Bit
 * @param len Length
 * @param access RW Access
 * @param nvm NVM Type
 */
struct RegDes {
const uint8_t addr;
...
/**
 * @brief Protecction descriptor table
 * @param desc      Descriptor
 * @param regs      Relevant MP2790::<...> registers to check or nullptr
 * @param nRegs     Size of relevant regs
 * @param clear     Regs to clear 
 * @param nClear    Size of regs to clear 
 */
struct Protection {
  const char* name;
  const RegDes* regs;
...
/**
 * @brief Namespace for all MP2790 protection register arrays.
 */
namespace { 
    using namespace MP2790_Reg;

    //Interrupt table
    constexpr RegDes RD_CELL_OV_REGS[10] = {
        CELL_1_OV_STS, CELL_2_OV_STS, CELL_3_OV_STS,
        CELL_4_OV_STS, CELL_5_OV_STS, CELL_6_OV_STS,
        CELL_7_OV_STS, CELL_8_OV_STS, CELL_9_OV_STS,
        CELL_10_OV_STS
    };
    constexpr RegDes RD_CELL_UV_REGS[10] = {
        CELL_1_UV_STS, CELL_2_UV_STS, CELL_3_UV_STS,
        CELL_4_UV_STS, CELL_5_UV_STS, CELL_6_UV_STS,
        CELL_7_UV_STS, CELL_8_UV_STS, CELL_9_UV_STS,
        CELL_10_UV_STS
    };
    constexpr RegDes OC_REGS[3] = {
        OC1_DCHG_STS, OC2_DCHG_STS, OC_CHG_STS
    };
    constexpr RegDes SC_REGS[2] = {
        SC_DCHG_STS, SC_CHG_STS
    };    
    constexpr RegDes NTC_DSG_REGS[4] = {
        NTC1_CELL_DSG_STS, NTC2_CELL_DSG_STS, 
        NTC3_CELL_DSG_STS, NTC4_CELL_DSG_STS
    };
    constexpr RegDes NTC_CHG_REGS[4] = {
        NTC1_CELL_CHG_STS, NTC2_CELL_CHG_STS, 
        NTC3_CELL_CHG_STS, NTC4_CELL_CHG_STS
    };    
    constexpr RegDes WDT_REGS[2] = {
        WDT_BARKED, WDT_BITE
    };
    constexpr RegDes CONN_DET_REGS[4] = {
        LDDET_FAIL, CHGDET_FAIL, LD_IN, CHG_IN
    };
    constexpr RegDes OW_REGS[11] = {
        CELL_0_OPW_STS, CELL_1_OPW_STS, CELL_2_OPW_STS, CELL_3_OPW_STS,
        CELL_4_OPW_STS, CELL_5_OPW_STS, CELL_6_OPW_STS, CELL_7_OPW_STS,
        CELL_8_OPW_STS, CELL_9_OPW_STS, CELL_10_OPW_STS
    };
    constexpr RegDes DEAD_REGS[10] = {
        CELL_1_DEAD_STS, CELL_2_DEAD_STS, CELL_3_DEAD_STS,
        CELL_4_DEAD_STS, CELL_5_DEAD_STS, CELL_6_DEAD_STS,
        CELL_7_DEAD_STS, CELL_8_DEAD_STS, CELL_9_DEAD_STS,
        CELL_10_DEAD_STS
    };
    constexpr RegDes MISMATCH_REG[10] = {
        CELL_1_MSMT_STS, CELL_2_MSMT_STS, CELL_3_MSMT_STS,
        CELL_4_MSMT_STS, CELL_5_MSMT_STS, CELL_6_MSMT_STS,
        CELL_7_MSMT_STS, CELL_8_MSMT_STS, CELL_9_MSMT_STS,
        CELL_10_MSMT_STS
    };    
    constexpr RegDes OT_REGS[2] = {
        DIE_TEMP_DIG_RT_STS, DIE_TEMP_DIG_STS
    };
    constexpr RegDes NTC_OT_REGS[4] = {
        NTC1_PCB_MNTR_HOT_STS, NTC2_PCB_MNTR_HOT_STS,
        NTC3_PCB_MNTR_HOT_STS, NTC4_PCB_MNTR_HOT_STS
    };
    constexpr RegDes SELF_REGS[2] = {
        SELF_TEST_STS_UV, SELF_TEST_STS_OV
    };
    constexpr size_t M_RD_CELL_OV_REGS  = sizeof(RD_CELL_OV_REGS)/sizeof(RD_CELL_OV_REGS[0]);
    constexpr size_t M_RD_CELL_UV_REGS  = sizeof(RD_CELL_UV_REGS)/sizeof(RD_CELL_UV_REGS[0]);
    constexpr size_t M_OC_REGS          = sizeof(OC_REGS)/sizeof(OC_REGS[0]);
    constexpr size_t M_SC_REGS          = sizeof(SC_REGS)/sizeof(SC_REGS[0]);
    constexpr size_t M_NTC_DSG_REGS     = sizeof(NTC_DSG_REGS)/sizeof(NTC_DSG_REGS[0]);
    constexpr size_t M_NTC_CHG_REGS     = sizeof(NTC_CHG_REGS)/sizeof(NTC_CHG_REGS[0]);
    constexpr size_t M_WDT_REGS         = sizeof(WDT_REGS)/sizeof(WDT_REGS[0]);
    constexpr size_t M_CONN_DET_REGS    = sizeof(CONN_DET_REGS)/sizeof(CONN_DET_REGS[0]);
    constexpr size_t M_OW_REGS          = sizeof(OW_REGS)/sizeof(OW_REGS[0]);
    constexpr size_t M_DEAD_REGS        = sizeof(DEAD_REGS)/sizeof(DEAD_REGS[0]);
    constexpr size_t M_MISMATCH_REG     = sizeof(MISMATCH_REG)/sizeof(MISMATCH_REG[0]);
    constexpr size_t M_OT_REGS          = sizeof(OT_REGS)/sizeof(OT_REGS[0]);
    constexpr size_t M_NTC_OT_REGS      = sizeof(NTC_OT_REGS)/sizeof(NTC_OT_REGS[0]);
    constexpr size_t M_SELF_REGS        = sizeof(SELF_REGS)/sizeof(SELF_REGS[0]);


    //Fault table
    constexpr RegDes FT_CELL_OV[2] = {
        CELL_OV_FAULT_CLR,  //Manual
        CELL_OV_REC         //Auto, see (CELL_OV_CHG_REC_MODE)
    };
    constexpr RegDes FT_CELL_UV[2] = {
        CELL_UV_FAULT_CLR,  //Manual
        CELL_UV_REC         //Auto, see (CELL_OV_CHG_REC_MODE)
    };    
    constexpr RegDes FT_CELL_DEAD[2] = {
        CELL_DEAD_FAULT_CLR,    
        CELL_DEAD_DET_CLEAR //If CELL_DEAD_LOG_STS       
    };
    constexpr RegDes FT_NTC_CHG_HOTCOLD[2] = {
        NTC_CELL_CHG_FAULT_CLR, //Manual    
        NTC_CELL_CHG_REC     //Auto, see (NTC_CELL_CHG_REC_MODE and NTC_CELL_STBY_MODE)    
    };
    constexpr RegDes FT_NTC_DSG_HOTCOLD[2] = {
        NTC_CELL_DSG_FAULT_CLR, //Manual    
        NTC_CELL_DSG_REC     //Auto, see (NTC_CELL_STBY_MODE)   
    };
    constexpr RegDes FT_PCB_TEMP[2] = {
        PCB_MNTR_FAULT_CLR, //Manual    
        PCB_MNTR_REC,       //Auto
    };
    constexpr RegDes FT_DIE_TEMP[2] = {
        //Digital
        DIE_TEMP_FAULT_CLR, //Manual
        DIE_TEMP_FAULT_REC  //Auto
        //Analog
            //Auto recover
    };
}

constexpr Protection InterruptTable[] = {
  { "00_Cell OV"                ,RD_CELL_OV_REGS        ,M_RD_CELL_OV_REGS }, //#cell in OV
  { "01_Cell UV"                ,RD_CELL_UV_REGS        ,M_RD_CELL_UV_REGS},  //#cell in UV
  { "02_Stack TOP UV"           ,nullptr                ,0 },
  { "03_Stack TOP OV"           ,nullptr                ,0 },
  { "04_OC"                     ,OC_REGS                ,M_OC_REGS },         //OC DSG1, OC_DSG2, OC CHG
  { "05_SC"                     ,SC_REGS                ,M_SC_REGS },         //SC DSG, SC CHG
  { "06_NTC DSG"                ,NTC_DSG_REGS           ,M_NTC_DSG_REGS },    //NTC 1-4
  { "07_NTC CHG"                ,NTC_CHG_REGS           ,M_NTC_CHG_REGS },    //NTC 1-4
  { "08_WDT Barked"             ,WDT_REGS               ,M_WDT_REGS },        //Bark, Bite
  { "09_Fault recovered"        ,nullptr                ,0 },
  { "10_AFE mode change"        ,&PWR_STATE             ,1 },                 //0xi & {nA, nC, nB SBY, Safe}
  { "11_Scan complete"          ,nullptr                ,0 },
  { "12_CC done"                ,nullptr                ,0 },
  { "13_Plug-in detection"      ,CONN_DET_REGS          ,M_CONN_DET_REGS },   //LDDET_FAIL, CHGDET_FAIL, LD_IN, CHG_IN }
  { "14_Pack current"           ,&PACK_CURRENT_STATUS   ,1 },                 //0xi & {Charging, Standby, Discharging}
  ...
  { "18_3V3 UV"                 ,nullptr                ,0 },
  { "19_VDD UV"                 ,nullptr                ,0 },
  { "20_Open wire"              ,OW_REGS                ,M_OW_REGS },         //C# with OW //RD_OPENL not found
  { "21_Dead cell"              ,DEAD_REGS              ,M_DEAD_REGS },       //#cell dead
  { "22_Cell Mismatch"          ,MISMATCH_REG           ,M_MISMATCH_REG },    //#cell mismatch
  { "23_Die Over Temperature"   ,OT_REGS                ,M_OT_REGS },
  { "24_NTC in PCB mode Over Temperature",NTC_OT_REGS   ,M_NTC_OT_REGS },     //NTC 1-4
  { "25_Scheduler error"        ,nullptr                ,0 },
  { "26_Self test failed"       ,SELF_REGS              ,M_SELF_REGS },       //Self test UV, Self test OV
  { "27_Balancing complete"     ,nullptr                ,0 },                  
  { "28_PackP comparator changed", nullptr              ,0 },                 //0-4: {
  //Not available, VpackP<Vtop-1, Vtop+160mV>VpackP>Vtop-1, PackP comp invalid, VpackP>Vtop+208mv}
  { "29_Fet driver timeout"     ,&PWR_STATE             ,1 }
};
static const size_t M_InterruptTable = sizeof(InterruptTable)/sizeof(InterruptTable[0]);

static const Protection FaultTable[] = {
  { "00_Cell_UV_Fault"          ,nullptr ,0 ,FT_CELL_OV               ,2 },
  { "01_Cell_OV_Fault"          ,nullptr ,0 ,FT_CELL_UV               ,2 },
  { "02_Dead_Cell_Fault"        ,nullptr ,0 ,FT_CELL_DEAD             ,2 },
  { "03_Cell_Mismatch_Fault"    ,nullptr ,0 ,&CELL_MSMT_FAULT_CLR     ,1 },
  { "04_Open_Wire_Fault"        ,nullptr ,0 ,&OPEN_WIRE_FAULT_CLR     ,1 },
  { "05_VTOP_UV_Fault"          ,nullptr ,0 ,&VTOP_OV_FAULT_CLR       ,1 },
  { "06_VTOP_OV_Fault"          ,nullptr ,0 ,&VTOP_UV_FAULT_CLR       ,1 },
  { "07_PCB_Monitor_Fault"      ,nullptr ,0 ,FT_PCB_TEMP              ,2 },
  { "08_NTC_Cell_CHG_Fault"     ,nullptr ,0 ,FT_NTC_CHG_HOTCOLD       ,2 },
  { "09_NTC_Cell_DSG_Fault"     ,nullptr ,0 ,FT_NTC_DSG_HOTCOLD       ,2 },
  { "10_OC1_Discharge_Fault"    ,nullptr ,0 ,&OC1_DCHG_FAULT_CLR      ,1 },
  { "11_OC2_Discharge_Fault"    ,nullptr ,0 ,&OC2_DCHG_FAULT_CLR      ,1 },
  { "12_OC_Charge_Fault"        ,nullptr ,0 ,&OC_CHG_FAULT_CLR        ,1 },
  { "13_SC_Discharge_Fault"     ,nullptr ,0 ,&SC_DCHG_FAULT_CLR       ,1 },
  { "14_SC_Charge_Fault"        ,nullptr ,0 ,&SC_CHG_FAULT_CLR        ,1 },
  { "15_Die_Temp_Fault"         ,nullptr ,0 ,FT_DIE_TEMP              ,2 },
  { "16_OTP_CRC_Fault"          ,nullptr ,0 ,&OTP_CRC_CLR             ,1 },
  { "17_V3V3_Fault"             ,nullptr ,0 ,&V3V3_VDD_FAULT_CLR      ,1 },
  { "18_VDD_Fault"              ,nullptr ,0 ,&V3V3_VDD_FAULT_CLR      ,1 },
  { "19_Driver_turn_on_Fault"   ,nullptr ,0 ,&DRIVER_FAULT_CLR        ,1 },
  { "20_INVALID_FAULT_CODE"     ,nullptr ,0 ,nullptr                  ,0 },
  { "21_INVALID_FAULT_CODE"     ,nullptr ,0 ,nullptr                  ,0 },
  { "22_INVALID_FAULT_CODE"     ,nullptr ,0 ,nullptr                  ,0 },
  { "23_INVALID_FAULT_CODE"     ,nullptr ,0 ,nullptr                  ,0 },
  { "24_INVALID_FAULT_CODE"     ,nullptr ,0 ,nullptr                  ,0 },
  { "25_INVALID_FAULT_CODE"     ,nullptr ,0 ,nullptr                  ,0 },
  { "26_INVALID_FAULT_CODE"     ,nullptr ,0 ,nullptr                  ,0 },
  { "27_INVALID_FAULT_CODE"     ,nullptr ,0 ,nullptr                  ,0 },
  { "28_INVALID_FAULT_CODE"     ,nullptr ,0 ,nullptr                  ,0 },
  { "29_Removal_Busy"           ,nullptr ,0 ,nullptr                  ,0 },
};
static const size_t M_FaultTable = sizeof(FaultTable)/sizeof(FaultTable[0]);

typedef struct{
    uint16_t cellHRVoltage[10];
    int16_t cellHRCurrent[10];
    uint16_t ntcHRValues[4];
    uint16_t gpioHRValues[3];
    uint16_t adcHRValues[3];
    uint16_t packPReadings;
    uint16_t vTopReadings;
    int16_t iTopReadings;
    uint16_t dieTemp;
} mpDataP;
...
public:
    ...
    // void clearInt(uint8_t interruptNum); 
    // bool getFault(bool* fautlFlags);
    // void clearFault(uint8_t faultNum); 
    ...
    mpDataP getADCVals();
        ...
        void getNTCreadings(int32_t* ntcValues);               //For NTC 1-4
        ...
        int32_t tempConversion(double rawData); 

    //HR ADC readings
    void triggerHRScan(uint8_t trigger);
    mpDataP getHRADCVals();
        //Sub methods
