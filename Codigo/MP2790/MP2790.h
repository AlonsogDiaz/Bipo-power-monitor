...
// Enum for Non-NVMType::VOLATILE Memory type
enum class NVMType {
    VOLATILE,
...
/**
 * @brief Register descritor structure
...
namespace { 
    ...
    constexpr RegDes SELF_REGS[2] = {
        SELF_TEST_STS_UV, SELF_TEST_STS_OV //,SELF_STS, SCAN_ERROR_STS, SCAN_DONE_STS
    };
    //Balance complete
    //Packp volt
    //*Fet timeout
...
static const Protection FaultTable[] = {
  { "00_Cell_UV_Fault"          ,nullptr ,0 ,FT_CELL_OV               ,0 },
  { "01_Cell_OV_Fault"          ,nullptr ,0 ,FT_CELL_UV               ,0 },
  { "02_Dead_Cell_Fault"        ,nullptr ,0 ,FT_CELL_DEAD             ,0 },
  { "03_Cell_Mismatch_Fault"    ,nullptr ,0 ,&CELL_MSMT_FAULT_CLR     ,0 },
  { "04_Open_Wire_Fault"        ,nullptr ,0 ,&OPEN_WIRE_FAULT_CLR     ,0 },
  { "05_VTOP_UV_Fault"          ,nullptr ,0 ,&VTOP_OV_FAULT_CLR       ,0 },
  { "06_VTOP_OV_Fault"          ,nullptr ,0 ,&VTOP_UV_FAULT_CLR       ,0 },
  { "07_PCB_Monitor_Fault"      ,nullptr ,0 ,FT_PCB_TEMP              ,0 },
  { "08_NTC_Cell_CHG_Fault"     ,nullptr ,0 ,FT_NTC_CHG_HOTCOLD       ,0 },
  { "09_NTC_Cell_DSG_Fault"     ,nullptr ,0 ,FT_NTC_DSG_HOTCOLD       ,0 },
  { "10_OC1_Discharge_Fault"    ,nullptr ,0 ,&OC1_DCHG_FAULT_CLR      ,0 },
  { "11_OC2_Discharge_Fault"    ,nullptr ,0 ,&OC2_DCHG_FAULT_CLR      ,0 },
  { "12_OC_Charge_Fault"        ,nullptr ,0 ,&OC_CHG_FAULT_CLR        ,0 },
  { "13_SC_Discharge_Fault"     ,nullptr ,0 ,&SC_DCHG_FAULT_CLR       ,0 },
  { "14_SC_Charge_Fault"        ,nullptr ,0 ,&SC_CHG_FAULT_CLR        ,0 },
  { "15_Die_Temp_Fault"         ,nullptr ,0 ,FT_DIE_TEMP              ,0 },
  { "16_OTP_CRC_Fault"          ,nullptr ,0 ,nullptr                  ,0 },
  { "17_V3V3_Fault"             ,nullptr ,0 ,&V3V3_VDD_FAULT_CLR      ,0 },
  { "18_VDD_Fault"              ,nullptr ,0 ,&V3V3_VDD_FAULT_CLR      ,0 },
  { "19_Driver_turn_on_Fault"   ,nullptr ,0 ,&DRIVER_FAULT_CLR        ,0 },
...
public:
    ...
    HRDataPacket getADCVals();

    //HR ADC readings
    void triggerHRScan(uint8_t trigger);
    HRDataPacket getHRADCVals();
        //Sub methods
